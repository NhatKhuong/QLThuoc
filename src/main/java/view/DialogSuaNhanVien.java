...
public class DialogSuaNhanVien extends JDialog implements ActionListener {
	...
	public NhanVien layDuLieu() {
		...
		//sdt.equalsIgnoreCase(nhanVien.getSoDienThoaiNV()) && NhanVien.kiemTraSoDienThoai(conn, sdt)
//		if (!sdt.equalsIgnoreCase(nhanVien.getSoDienThoaiNV()) && NhanVien.kiemTraSoDienThoai(conn, sdt)) {
